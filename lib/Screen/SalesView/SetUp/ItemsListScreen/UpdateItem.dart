...
class _UpdateItemScreenState extends State<UpdateItemScreen> {
  ...
  void initState() {
    ...
    // Prefill fields
    itemNameCtrl.text = widget.item.itemName;
    perUnitCtrl.text = widget.item.purchase.toString();
    reorderCtrl.text = widget.item.reorder.toString();
    itemKindCtrl.text = widget.item.itemKind ?? "";

    selectedCategoryId = widget.item.itemCategory?.id;
    selectedTypeId = widget.item.itemType?.id;
    selectedUnitId = widget.item.itemUnit?.id;
                    ...
                    child: ClipRRect(
                      ...
                      child: pickedImage != null
                        ...
                        fit: BoxFit.contain,
                          ...
                          : (widget.item.itemImage?.url != null
                          ? Image.network(
                        widget.item.itemImage!.url!,
                        fit: BoxFit.contain,
                      )
