...
class CustomerDropdown extends StatefulWidget {
  ...
  final bool showDetails; // ✅ NEW PARAMETER
  ...
  const CustomerDropdown({
    ...
    this.selectedCustomerId,
    this.label = "Select Customer",
    this.showDetails = true,   // ✅ default: show details
  });
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          onChanged: (id) {
            selectedCustomer = provider.customer.firstWhere((c) => c.id == id);
            widget.onChanged(selectedCustomer);
            setState(() {});
          },
        ),
        ...
        /// ✅ Show Details OR Not (controlled by parameter)
